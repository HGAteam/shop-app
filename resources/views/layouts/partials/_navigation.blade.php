            ...
            <div class="row align-items-center">
                ...
                <div class="col d-lg-none ">
                    <div class="ec-header-bottons">
                        ...
                        @else
                        <div class="ec-header-user dropdown">
                            <button class="dropdown-toggle" data-bs-toggle="dropdown"><i class="fi-rr-user"></i>{{ Auth::user()->name }}</button>
                            <ul class="dropdown-menu dropdown-menu-right">
                                <li>
                                    <a class="dropdown-item" href="{{ route('home')}}">{{ __('My Account')}}</a></li>
                                <li>
