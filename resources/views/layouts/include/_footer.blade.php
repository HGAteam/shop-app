<footer class="footer_area h_footer_dark pos_footer_area">
  <img class="leaf_left" src="{{asset('img/pos/leaf-left.png')}}" alt="">
  <img class="leaf_right" src="{{asset('img/pos/leaf-right.png')}}" alt="">
  <div class="container">
      <div class="row">
          <div class="col-lg-4 col-md-6">
              <div class="f_widget dark_widget company_widget">
                  <a href="index.html" class="f-logo"><img src="{{asset('img/logo2.png')}}" alt=""></a>
                  <p>© 20122 Liftitfy, LLC. {{ __('All rights reserved')}}. {{ __('Proudly made in')}} OF</p>
      ...
      <div class="pos_footer_bottom justify-content-between d-flex align-items-end">
          <img class="pos_women" src="{{asset('img/pos/women.png')}}" alt="">
          <img src="{{asset('img/pos/people.png')}}" alt="">
          <img class="pos_women" src="{{asset('img/pos/man.png')}}" alt="">
      </div>
  </div>
