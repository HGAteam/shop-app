                ...
                <div class="card-body pt-0">
                    ...
                    <form action="" method="post" enctype="multipart/form-data" id="new_product">
                        ...
                        <div class="row">
                            ...
                            <div class="col-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <label for="">{{ __('Old Price') }}</label>

                                    <input type="number" placeholder="US$ 1.0" step="0.01" name="old_price"
                                        class="form-control">
                            ...
                            <div class="col-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" placeholder="US$ 1.0" step="0.01" name="price"
                                        class="form-control">
                        ...
                        <div class="d-flex justify-content-center">
                            ...
                            <button type="button" data-process="submit"
                                class="btn btn-primary">{{ __('Create') }}</button>

                            <button type="button" data-process="cancel"
...
<div class="modal fade" id="edit_product" tabindex="-1" role="dialog" aria-labelledby="edit_product"
    aria-hidden="true">
                    ...
                    <div class="row">
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <input type="number" placeholder="US$ 1.0" step="0.01" name="edit_old_price"
                                    class="form-control">

                                <small id="error-edit_old_price" class="text-danger"></small>
                        ...
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <input type="number" placeholder="US$ 1.0" step="0.01" name="edit_price"
                                    class="form-control">
            ...
            submitButton.addEventListener("click", function(e) {
                ...
                $.ajax({
                    ...
                    error: function(response) {
                        ...
                        $('#error-old_price').text(response.responseJSON.errors.old_price);
            ...
            var handleEditRow = () => {
                ...
                editButtons.forEach((ed) => {
                    ...
                    ed.addEventListener("click", function(e) {
                        ...
                        update_form.querySelector('[name="edit_category"]').selected = parent
                            .querySelectorAll('td')[2].innerText;

                        update_form.querySelector('[name="edit_old_price"]').value = parent
                            .querySelectorAll('td')[3].innerText;

                        update_form.querySelector('[name="edit_price"]').value = parent
                            .querySelectorAll('td')[4].innerText;

                        update_form.querySelector('[name="edit_description"]').value = parent
                            .querySelectorAll('td')[5].innerText;

                        update_form.action = parent.querySelectorAll("td")[6].querySelectorAll(
                            "a")[1].href;
