                                ...
                                <tr>
                                    <td align="left" valign="top">
                                        ...
                                        <a href="#" target="_blank" style="display: block; max-width: 128px;">
                                            <img src="https://liftingother.com/images/altcoin.png" alt="img"
                                                width="128" border="0" style="display: block; width: 128px;" />
                                        </a>
                                ...
                                <tr>
                                    <td align="left" valign="top">
                                        <font face="'Source Sans Pro', sans-serif" color="#1a1a1a"
                                            ...
                                            <span
                                                style="font-family: 'Source Sans Pro', Arial, Tahoma, Geneva, sans-serif; color: #1a1a1a; font-size: 52px; line-height: 60px; font-weight: 300; letter-spacing: -1.5px;">Hi
                                                there {{ $user->name . ' ' . $user->last_name }},</span>
                                        </font>
                                        <div style="height: 33px; line-height: 33px; font-size: 31px;">&nbsp;</div>
                                        <font face="'Source Sans Pro', sans-serif" color="#585858"
                                            style="font-size: 24px; line-height: 32px;">
                                            <span
                                                style="font-family: 'Source Sans Pro', Arial, Tahoma, Geneva, sans-serif; color: #585858; font-size: 24px; line-height: 32px;">We
                                                would like to inform you that the order statement has changed to
                                                {{ $cart->status }}</span>
                                        </font>
                                        ...
                                        <font face="'Source Sans Pro', sans-serif" color="#585858"
                                            style="font-size: 24px; line-height: 32px;">
                                            <span
                                                style="font-family: 'Source Sans Pro', Arial, Tahoma, Geneva, sans-serif; color: #585858; font-size: 24px; line-height: 32px;">If
                                                you have any questions, please write to us at <a
                                                    href="mailto:info@liftingother.com">info@liftingother.com</a></span>
                                        </font>
                                        <div style="height: 33px; line-height: 33px; font-size: 31px;">&nbsp;</div>
                                        <table class="mob_btn" cellpadding="0" cellspacing="0" border="0"
                                            ...
                                            <tr>
                                                <td align="center" valign="top">
                                                    <a href="https://liftingother.com/home/orders" target="_blank"
                                                        style="display: block; border: 1px solid #27cbcc; border-radius: 4px; padding: 12px 23px; font-family: 'Source Sans Pro', Arial, Verdana, Tahoma, Geneva, sans-serif; color: #ffffff; font-size: 20px; line-height: 30px; text-decoration: none; white-space: nowrap; font-weight: 600;">
                                                        <font face="'Source Sans Pro', sans-serif" color="#ffffff"
                                                            ...
                                                            <span
                                                                style="font-family: 'Source Sans Pro', Arial, Verdana, Tahoma, Geneva, sans-serif; color: #ffffff; font-size: 20px; line-height: 30px; text-decoration: none; white-space: nowrap; font-weight: 600;">Take
                                                                me to&nbsp;my&nbsp;orders</span>
                                                        </font>
                                                    </a>
                                                </td>
                                            </tr>
                                                ...
                                                <tr>
                                                    <td align="center" valign="top">
                                                        ...
                                                        <div style="display: block; max-width: 50px;">
                                                            <img src="https://liftingother.com/images/altcoin.png"
                                                                alt="img" width="50" border="0"
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="mob_center" align="left" valign="top">
                                                        ...
                                                        <font face="'Source Sans Pro', sans-serif" color="#000000"
                                                            ...
                                                            <span
                                                                style="font-family: 'Source Sans Pro', Arial, Tahoma, Geneva, sans-serif; color: #000000; font-size: 19px; line-height: 23px; font-weight: 600;">LiftingOther
                                                                Administration</span>
                                                        </font>
                                                        ...
                                                        <font face="'Source Sans Pro', sans-serif" color="#7f7f7f"
                                                            ...
                                                            <span
                                                                style="font-family: 'Source Sans Pro', Arial, Tahoma, Geneva, sans-serif; color: #7f7f7f; font-size: 19px; line-height: 23px;">Thank
                                                                you, Regards!</span>
                                                        </font>
                                                    </td>
                                                    <td width="18"
                                    ...
                                    <td align="center" valign="top">
                                        ...
                                        <font face="'Source Sans Pro', sans-serif" color="#868686"
                                            ...
                                            <span
                                                ...
                                                &copy; 2022 Liftingother LLC. All&nbsp;Rights&nbsp;Reserved.</span>
                                        </font>
                                        ...
                                        <font face="'Source Sans Pro', sans-serif" color="#1a1a1a"
                                            ...
                                            <span
                                                style="font-family: 'Source Sans Pro', Arial, Tahoma, Geneva, sans-serif; color: #1a1a1a; font-size: 17px; line-height: 20px;"><a
                                                    href="mailto:info@liftingother.com" target="_blank"
                                                    style="font-family: 'Source Sans Pro', Arial, Tahoma, Geneva, sans-serif; color: #1a1a1a; font-size: 17px; line-height: 20px; text-decoration: none;">info@liftingother.com</a>
                                                &nbsp;&nbsp;|&nbsp;&nbsp; <a href="#" target="_blank"
                                                    style="font-family: 'Source Sans Pro', Arial, Tahoma, Geneva, sans-serif; color: #1a1a1a; font-size: 17px; line-height: 20px; text-decoration: none;">321-200-0440</a>
                                                &nbsp;&nbsp;|&nbsp;&nbsp; <a href="#" target="_blank"
                                                    style="font-family: 'Source Sans Pro', Arial, Tahoma, Geneva, sans-serif; color: #1a1a1a; font-size: 17px; line-height: 20px; text-decoration: none;">Aloma
                                                    ave. Suite 145, Winter Park, FL 32792</a></span>
                                        </font>
