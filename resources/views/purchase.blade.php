...
@section('content')
    ...
    @endphp
    <div class="row example example-2" style="background-color:#F8F8F9;">
        <div id="loader-example-2" class="loader"></div>
            <div id="customContainer" class="exampleX custom">
                <div class="containerX">
                    <h1 style="text-align:center;">{{$product->name . ' - US$' . $product->price}}</h1>
                    <div class="field newPayment">
                        <label class="radiocontainer">New Payment Card
                            <input type="radio" checked="checked" name="radio">
                            <span class="radiomark"></span>
                        </label>
                        <img id="visa" alt="visa" class="brand-img visa first" src="/dlocal/img/visa.svg" />
                        <img id="mastercard" alt="mastercard" class="brand-img mastercard" src="/dlocal/img/master.svg" />
                        <img id="amex" alt="amex" class="brand-img amex" src="/dlocal/img/amex.svg" />
                        <img id="discover" alt="discover" class="brand-img discover" src="/dlocal/img/discover.svg" />
                    </div>
                    <hr>
                    ...
                    <div id="fieldExpirationContainer" class="field cuarter fieldFloating">
                        <div id="containerExpiration" class="input empty" onclick="clickExpiration()"></div>
                    ...
                    <div id="fieldCVVContainer" class="field cuarter fieldFloating">
                        ...
                        <div class="tooltipContainer">
                            <img id="cvvTooltip" alt="cvv" class="tooltipImage" src="/dlocal/img/question.svg" />
                            <div class="tooltipInner">
                                <img class="tooltipInnerImage" src="/dlocal/img/security_code.svg">
                            </div>
                        </div>
                    ...
                    <div class="field fieldFloating" id="nameContainer">
                        ...
                        <input id="name" type="text" placeholder="John Doe" required class="input empty"
                    ...
                    <div style="margin-left:3px" class="terms">
            ...
            <div class="success">
                ...
                <p class="message">
                    <span id="example-2.success.message">Thanks for trying Smart Fields. No money was charged, but we
                        generated
                        a token: </span>
            ...
            <div class="secureConnection">
                <img alt="lock" src="/dlocal/img/lock.png" />
                <label>Secure Connection</label>
            </div>
        <a style="font-size:20px;" class="btn btn-primary" href="{{ route('welcome') }}">
            {{ __('Cancel') }}
        </a>
    </div>
@endsection
