...
@section('content')
    ...
    <!-- MODAL1 -->
    @include('layouts.components.modals.modal-1')

    <!-- newsletter -->
    @include('layouts.components.modals.newsletter')
    ...
    <!-- PURCHASE popup -->
    @include('layouts.components.popups.recent-purchase')
    ...
    <!-- Feature tools -->
    @include('layouts.components.features.feature-tool')
@endsection
